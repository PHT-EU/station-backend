...
def run_pht_train():
    ...
    def get_train_image_info():
        ...
        repository, tag, env, volumes, gpu, check_results = [
            context["dag_run"].conf.get(_, None)
            for _ in ["repository", "tag", "env", "volumes", "gpus", "check_results"]
        ]
    ...
    def execute_container(train_state):
        ...
        to_container.commit(
            repository=train_state["repository"], tag=train_state["tag"]
        )
